...
logger = get_logger('analyticsfish.zep_entity_reader')
...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        logger.info(
            f"Filtering completed: total_nodes={total_count}, matched={len(filtered_entities)}, "
            f"entity_types={entity_types_found}"
        )
