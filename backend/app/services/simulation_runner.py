...
logger = get_logger('analyticsfish.simulation_runner')
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        if not os.path.exists(config_path):
            raise ValueError(f"Simulation config does not exist. Call /prepare first.")
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        ...
        logger.info(f"Simulation log cleanup completed: {simulation_id}, deleted_files: {cleaned_files}")
    ...
    def close_simulation_env(
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Environment shutdown command sent (response timed out; the environment may still be shutting down)"
            }
