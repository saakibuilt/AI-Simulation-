...
class TwitterSimulationRunner:
    ...
    async def run(self, max_rounds: int = None):
        ...
        if initial_posts:
            ...
            for post in initial_posts:
                ...
                try:
                    ...
                    print(f"  Warning: failed to create initial post for agent {agent_id}create initial post: {e}")
        ...
        if self.wait_for_commands:
            print("\n" + "=" * 60)
            print("Entering wait-for-command mode - environment stays running")
...
async def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help='Maximum simulation rounds (optional; used to cap long runs)'
    )
    parser.add_argument(
        '--no-wait',
        action='store_true',
        default=False,
        help='Close the environment immediately after the simulation instead of entering wait-for-command mode'
    )
